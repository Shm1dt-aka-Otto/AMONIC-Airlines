    ...
    public partial class Searchflight : Form
    {
        ...
        private void bookButton_Click(object sender, EventArgs e)
        {
            if (returnGridView.Visible == false)
            {
                ...
                Bookingconfirmation book = new Bookingconfirmation(from, to, date, number, cabin,
            ...
            else
            {
                ...
                int passanger = Convert.ToInt32(passangerText.Text);
                Bookingconfirmation book = new Bookingconfirmation(fromOutbound, toOutbound, dateOutbound,
