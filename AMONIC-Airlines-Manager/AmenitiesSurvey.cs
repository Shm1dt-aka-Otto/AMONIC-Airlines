...
namespace AMONIC_Airlines_5
{
    public partial class AmenitiesSurvey : Form
    {
        ...
        private void AmenitiesSurvey_Load(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT Date from schedules order by Date asc";
        ...
        private void dateBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            scheduleBox.Items.Add("All schedules");
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            if (scheduleBox.Enabled == true && scheduleBox.Text != "All schedules")
            {
            ...
            else
            {
                ...
                for (int i = 1; i < scheduleBox.Items.Count; i++)
                {
                    for (int j = 0; j < 3; j++)
                    {
                        string sql = "";
