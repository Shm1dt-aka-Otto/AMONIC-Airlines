...
namespace AMONIC_Airlines_3
{
    public partial class Bookingconfirmation : Form
    {
        ...
        string IdOutbound = "", IdReturn = "";
        string idUser = "";
        public Bookingconfirmation(string userId, string fromOut, string toOut, string dateOut,
        ...
        private void confirmButton_Click(object sender, EventArgs e)
        {
            ...
            if (returnDetailBox.Visible == false)
            {
                ...
                ConfirmBooking confirm = new ConfirmBooking(idUser, allPrice * checkForBlock,
